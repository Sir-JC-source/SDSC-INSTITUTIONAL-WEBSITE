...
<head>
  ...
  <title>St. Dominic Savio College Ibaan</title>
...
.navbar-brand {
  margin-right: 33px !important;   /* EXTRA SPACING ADDED ✔ */
}
...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    ...
    <!-- LOGO -->
<a class="navbar-brand fw-bold text-success d-flex align-items-center" href="ibaan.php">
  <img src="assets/images/logo.png" alt="Logo">

  <span class="ms-2 brand-text">
    St. Dominic Savio College <br>
    <span class="ms-2 brand-text">IBAAN Branch</span>
  </span>
</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto flex-nowrap">
        ...
        <!-- HOME -->
        <li class="nav-item">
          <a class="nav-link" href="ibaan.php">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="dropdown-submenu">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="elementary.php">
                    <i class="fa-solid fa-children submenu-icon"></i> Elementary
                  </a>
                </li>

                <li>
                  <a class="dropdown-item" href="juniorhigh.php">
                    <i class="fa-solid fa-user-group submenu-icon"></i> Junior High School
                  </a>
                </li>
              ...
              <ul class="dropdown-menu">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown-submenu">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="businessad.php"><i class="fa-solid fa-chart-line submenu-icon"></i> BS Business<br> Administration</a></li>
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item dropdown-toggle"
                        <i class="fa-solid fa-shield-halved submenu-icon"></i> College of <br>Criminal Justice
                      </a>
                      <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a class="dropdown-item dropdown-toggle">
                        <i class="fa-solid fa-laptop submenu-icon"></i> Engineering <br>& Computer Studies
                      </a>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="comsci.php"><i class="fa-solid fa-code submenu-icon"></i> BS Computer<br>Science</a></li>
                        <li><a class="dropdown-item" href="comengr.php"><i class="fa-solid fa-microchip submenu-icon"></i> BS Computer<br>Engineering</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu">
                      <a class="dropdown-item dropdown-toggle" href="maed.php">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
            <i class="fa-solid fa-building menu-icon"></i> Student Services
          </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="clir.php"><i class="fa-solid fa-book submenu-icon"></i> Library</a></li>
            <li><a class="dropdown-item" href="its.php"><i class="fa-solid fa-computer submenu-icon"></i> Information Technology</a></li>
            <li><a class="dropdown-item" href="guidance.php"><i class="fa-solid fa-user-group submenu-icon"></i> Guidance & Counseling</a></li>
            <li><a class="dropdown-item" href="research.php"><i class="fa-brands fa-researchgate submenu-icon"></i> Research</a></li>
          </ul>
        </li>

        <!-- OTHERS -->
        <li class="nav-item"><a class="nav-link" href="admission_ibaan.php"><i class="fa-solid fa-file-circle-check menu-icon"></i> Admission</a></li>
        <li class="nav-item"><a class="nav-link" href="events_ibaan.php"><i class="fa-solid fa-calendar-days menu-icon"></i> Events</a></li>
        <li class="nav-item"><a class="nav-link" href="facilities_ibaan.php"><i class="fa-solid fa-house menu-icon"></i> Facilities</a></li>
        <li class="nav-item"><a class="nav-link" href="index.php"><i class="fa-solid fa-location-dot menu-icon"></i> SDSC - Main Campus</a></li>
        <li class="nav-item"><a class="nav-link" href="contact_ibaan.php"><i class="fa-solid fa-envelope menu-icon"></i> Contact Us</a></li>
      </ul>
    </div>
  </div>
</nav>
